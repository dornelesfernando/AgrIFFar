            ...
            <div className={styles.topContainer}>
                <div className={styles.info_box}>
                    ...
                    <div className={styles.info_buttons}>
                        <a href="../agricultor/formularioagricultor.php"> <button className={`${styles.info_btn} ${styles.nav_btn}`}>Cadastro</button></a>
                        <a href="../login.php"> <button className={`${styles.info_btn} ${styles.nav_btn}`}>Login</button></a>
                    </div>
                </div>
